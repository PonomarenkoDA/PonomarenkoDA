...
### Обо мне:
- Аналитик Департамента анализа данных и моделирования (ДАДМ) ПАО "ВТБ Банк"
- Высшее техническое образование с отличием (НИУ "МЭИ", 2024г.);
- Магистр информационных технологий ИКН НИТУ МИСИС по направлению ИВТ;
- Выпускник курса по анализу данных Школы Data Science 'karpov.courses';
...
<div>
  ...
  <img src="https://img.shields.io/badge/Apache%20Spark-white?style=for-the-badge&logo=apache%20spark&logoColor=orange" title="Spark" alt="Spark" height="33"/>&nbsp;
  <img src="https://img.shields.io/badge/scikit--learn-white?logo=scikit-learn&logoColor=F7931E&labelColor=white&color=white&style=for-the-badge" title="Sklearn" alt="Sklearn" height="33"/>&nbsp;  
...
| :-------------: | ------------- | --- |
| **ML: <br/> Прогноз оттока клиентов в telecom** <br/> [(подробнее)](https://github.com/PonomarenkoDA/ml-churn-predict) | Выполнение предварительного анализа признаков, корреляционного анализа и тестирование различных алгоритмов и ансамблей машинного обучения с целью выявить наиболее эффективный алгоритм и оптимальный по сложности и качеству алгоритм.  | Python, pandas, numpy, sklearn, Catboost, LightGBM, XGBoost, seaborn, matplotlib, Jupyter Notebook | 
...
| [Дашборд Redash (karpov.courses)](https://redash.lab.karpov.courses/public/dashboards/NUD0EQPcw8adwSMlqMx8WDP7SNHR7eAp7V164qmh?org_slug=default) | Дашборд (операционный) с анализом продаж авокадо в США и оценкой продаж в регионах (Сан-Франциско, Нью-Йорк).| Redash |
